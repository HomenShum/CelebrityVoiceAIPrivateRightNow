...
with open("C:/Users/hshum/OneDrive/Desktop/Python/ChatGPT/oprah_nelson_mandela.txt", "r", encoding="utf-8") as file:
    text = file.read()
...
for line in lines:
    ...
    if line.startswith("Oprah: ") and line.endswith("?"):
        # Set the current prompt to the line
        prompt = line[7:]
    # Check if the line is a completion
    if line.startswith("Nelson Mandela: "):
...
with open("C:/Users/hshum/OneDrive/Desktop/Python/ChatGPT/oprah_nelson_mandela_PNP.txt", "w", encoding="utf-8") as f:
